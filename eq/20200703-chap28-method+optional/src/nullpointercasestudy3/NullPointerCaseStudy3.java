...
public class NullPointerCaseStudy3
{
	...
	{
		String addr = f.flatMap(Friend::getCmp).flatMap(Company::getCInfo).flatMap(ContInfo::getAdrs).orElse("There is no address information.");
